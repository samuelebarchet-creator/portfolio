...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tag: 'AI · SaaS · B2B',
    fullDescription:
      "Citation Rate è una piattaforma digitale focalizzata sulla visibilità dei brand nei sistemi di intelligenza artificiale e nei nuovi ecosistemi di ricerca. Il lavoro ha riguardato la definizione del posizionamento del prodotto, la semplificazione del messaggio chiave e del valore offerto, il supporto alla comunicazione B2B e all'onboarding concettuale, e la traduzione di un tema complesso — l'AI visibility — in un linguaggio accessibile e convincente per il mercato. Un progetto all'intersezione tra AI, marketing e strategia di crescita digitale.",
    deliverables: [
