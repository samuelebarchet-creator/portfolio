...
export default function AetherHero({
  ...
  const hasBuiltinContent = title || ctaLabel || secondaryCtaLabel;
  ...
  return (
    ...
    >
      ...
      {/* Custom children (slot for external content) */}
      {children && (
      ...
      {/* Built-in content (title/subtitle/CTA via props) */}
      {!children && hasBuiltinContent && (
        <div
          style={{
            position: 'relative',
            zIndex: 2,
            ...
            color: textColor,
            fontFamily: 'var(--font-barlow-condensed), ui-sans-serif, system-ui',
          }}
        >
          <div
            style={{
